            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
              ...
              <div className="space-y-5 text-gray-700">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 mt-1 shrink-0 text-[#73893b]" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Phone className="w-5 h-5 mt-1 shrink-0 text-[#73893b]" />
                  <div className="space-y-1">
                    ...
                    {phoneNumbers.map((phone) => (
                      <a
                        ...
                        className="block hover:text-[#73893b] transition-colors"
                      >
                        {phone}
                      </a>
                    ))}
                ...
                <div className="flex items-start gap-3">
                  <Mail className="w-5 h-5 mt-1 shrink-0 text-[#73893b]" />
                  <div className="space-y-1">
                    <p className="text-sm font-semibold text-gray-900">{t("email")}</p>
                    <a href={`mailto:${content?.site.email ?? "fundatiadpc@gmail.com"}`} className="block hover:text-[#73893b] transition-colors">
                ...
                {content?.site.facebook && (
                  <div className="flex items-start gap-3">
                    <div className="w-5 h-5 mt-1 shrink-0 rounded-full bg-[#73893b] text-white text-[11px] font-bold flex items-center justify-center">
                      f
                    </div>
                    <div className="space-y-1">
